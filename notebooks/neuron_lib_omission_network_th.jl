...
begin
	...
	thalamic_neuron_i = [16, 17]
	sensory_neuron_i = [1, 2, 3, 4]
	gabab_neuron_i = [13, 14, 15]
	mid_neurons_i = [5, 6, 7, 8]
	ssa_neurons_i = [9, 10, 11, 12]
	rules = []
	for i in thalamic_neuron_i
		push!(rules, SNN.Params.make_rule("e_neuron", i, "soma__b", 600e-12))
		push!(rules, SNN.Params.make_rule("e_neuron", i, "soma__a", -2.0e-9))
		push!(rules, SNN.Params.make_rule("e_neuron", i, "soma__TauW", 600e-3))
		push!(rules, SNN.Params.make_rule("e_neuron", i, "soma__group", 0))
		push!(rules, SNN.Params.make_rule("e_neuron", i, "soma__Ibase", 0.0e-10))
		push!(rules, SNN.Params.make_rule("e_neuron", i, "soma__input_value", 0))
		push!(rules, SNN.Params.make_rule("e_neuron", i, "soma__Cm", 4e-10))
		push!(rules, SNN.Params.make_rule("e_neuron", i, "soma__sigma", 0.00001))
		push!(rules, SNN.Params.make_rule("e_neuron", i, "ampa_syn__inc_gsyn_ampa", 0.0e-9))
		push!(rules, SNN.Params.make_rule("e_neuron", i, "soma__delta", 2))
	end
...
begin
	con_mapping = [
		...
		(SNN.Params.@connect_neurons thalamic_neuron_i SNN.Neuron.AMPA() thalamic_neuron_i)...;
...
# ╔═╡ 1637a326-6d29-4b8a-aa3c-9d9fa74d9145
pre_neurons[1]
...
# ╔═╡ 28dd53de-3008-4c23-bde4-3c454cc11173
readout
...
# ╔═╡ 258ba803-b9b9-4e9e-b66c-589cfc3ff727
agg_rate
...
SNN.Plots.csi(agg_rate, ot, -0.1, 0.1)

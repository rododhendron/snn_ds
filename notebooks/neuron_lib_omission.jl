...
begin
	...
	rules = []
	push!(rules, SNN.Params.make_rule("e_neuron", 2, "soma__b", 0e-10))
	push!(rules, SNN.Params.make_rule("e_neuron", 3, "soma__b", 0e-10))
	push!(rules, SNN.Params.make_rule("e_neuron", 2, "soma__a", 0e-10))
	push!(rules, SNN.Params.make_rule("e_neuron", 3, "soma__a", 0e-10))
	push!(rules, SNN.Params.make_rule("e_neuron", 2, "soma__group", 1))
	push!(rules, SNN.Params.make_rule("e_neuron", 3, "soma__group", 1))
	push!(rules, SNN.Params.make_rule("e_neuron", 2, "soma__input_value", stim_params.amplitude))
	push!(rules, SNN.Params.make_rule("e_neuron", 3, "soma__input_value", stim_params.amplitude))

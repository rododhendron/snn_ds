...
begin
@named neuron = ODESystem(eqs, t; tspan=tspan, continuous_events=[[vpre ~ params.vthr + 50] => spike_affect_event_pre, [vpost ~ params.vthr + 50] => spike_affect_event_post])
...
manifest_format = "2.0"
project_hash = "7365361567edaae966e942d7bde3d01f4008527d"
